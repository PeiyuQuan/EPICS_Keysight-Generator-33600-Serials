...
#include "keysightVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = keysightVERSION;
...
static lsidset devkeysightVersion = {
    5, NULL, NULL, NULL, NULL, read_string
};
epicsExportAddress(dset,devkeysightVersion);
